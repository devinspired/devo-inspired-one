		...
		formSubmit : function(){
			...
			$.ajax({
				...
				success: function(){
								...
								$('#message').html('<h3 class="subheader">Thank you!</h3>')
								.append('<h3 class="subheader">Someone from INSPIRED will get back to you ASAP.</h3>')
								.hide()
